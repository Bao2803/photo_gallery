...
// Bytes will help generate n random bytes, or will return an error if there was one.
...
// RememberToken is a helper function designed to generated remember tokens of a predetermined byte size.
